...
## contplot - create color/contour plots of 3-dimensional data

Function **contplot** (contour plot) fits a surface to 3-dimensional data and presents the fitted surface as a 2-dimensional color/contour plot. 'linear', 'spline', and 'loess' fitting methods are currently supported for this function.  
...
gridExtra::grid.arrange(
  nrow=3,
  p.cp.l + ggtitle('contplot w linear surface fit'),
  p.cp.s + ggtitle('contplot w spline surface fit'),
  p.cp.loess + ggtitle('contplot w loess surface fit'))
```
